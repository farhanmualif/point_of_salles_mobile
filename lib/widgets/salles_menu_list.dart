...
class SallesMenuList extends StatefulWidget {
  ...
  @override
  State<SallesMenuList> createState() => _SallesMenuListState();
}

class _SallesMenuListState extends State<SallesMenuList> {
